...
## 더 나은 길을 탐색하는 개발자 임성룡입니다.

### 문제의 본질을 파고들어 '더 나은 길'을 제시합니다.
개발 과정에서 마주하는 병목 현상과 비효율을 단순히 넘기지 않습니다.  
0.1초의 지연 시간을 줄이고 시스템 리소스를 효율화하기 위해 근본 원인을 분석하고 개선하는 과정을 즐깁니다.

### 기술의 깊이로 비즈니스의 가능성을 확장합니다.
단순히 기능을 구현하는 것에 그치지 않고, "이 기술이 왜 필요한가?"를 끊임없이 질문합니다.  
백엔드 시스템의 안정성을 확보하고 최신 AI 기술을 서비스에 최적화하여 적용하는 과정에서 개발의 즐거움을 느낍니다.
...
|활동명|기간|비고|
|:---:|:---:|:---:|
|[삼성청년SW·AI아카데미(SSAFY)](https://www.ssafy.com) 13기|2025.01 ~ 2025.12|삼성 SW 역량 테스트 A 등급 취득 <br />Certificate 등급: 우수|
|동의대학교 [인공지능그랜드ICT연구센터](https://www.aigrand.kr/)<br/>[DXLab](http://dxlab.ai/) 학부연구생|2023.07 ~ 2024.08|**창의자율과제**: AI 기반 맞춤형 학습 문제 생성 및 시험 관리 시스템 개발<br/>**기업 과제**: 데이터 수집 및 전처리 진행<br />**한의대 과제**: AI 기반 한의학 시뮬레이션 교육 플랫폼 개발|
|창업동아리 인사이트|2023.03 ~ 2024.08|파이썬 스터디장, 코테 스터디 진행|
|동의대학교 산업융합시스템공학부<br/>[산업ICT기술공학과](https://deuhome.deu.ac.kr/ind-ict/index.do) 졸업|2019.03 ~ 2025.02|[전체 평점: 3.99 / 4.5] <br/> [전공 평점: 4.25 / 4.5]|
